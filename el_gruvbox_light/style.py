...
class ELGruvboxLight(Style):
    ...
    styles = {
        ...
        Error:                     '#cc241d bold',  # red
        
        # Comments
        Comment:                   '#928374 italic',  # gray
        Comment.Multiline:         '#928374 italic',  # gray
        Comment.Single:            '#928374 italic',  # gray
        Comment.Special:           '#928374 italic bold',  # gray
        Comment.Preproc:           '#8f3f71',  # purple
        
        # Keywords
        Keyword:                   '#9d0006 bold',  # dark red
        Keyword.Constant:          '#9d0006 bold',  # dark red
        Keyword.Declaration:       '#9d0006 bold',  # dark red
        Keyword.Namespace:         '#9d0006 bold',  # dark red
        Keyword.Pseudo:            '#9d0006 bold',  # dark red
        Keyword.Reserved:          '#9d0006 bold',  # dark red
        Keyword.Type:              '#b57614 bold',  # yellow
        ...
        # Operators
        Operator:                  '#3c3836',  # fg1
        Operator.Word:             '#9d0006 bold',  # dark red
        ...
        Generic.Emph:              '#3c3836 italic',  # fg1
        Generic.Error:             '#cc241d bold',  # red
        Generic.Heading:           '#3c3836 bold',  # fg1
        Generic.Inserted:          '#79740e',  # green
        Generic.Output:            '#3c3836',  # fg1
        Generic.Prompt:            '#3c3836 bold',  # fg1
        Generic.Strong:            '#3c3836 bold',  # fg1
        Generic.Subheading:        '#3c3836 bold',  # fg1
